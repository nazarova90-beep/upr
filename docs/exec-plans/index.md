...
owner: Кристина
related: PLANS.md, ../../AGENTS.md, tech-debt-tracker.md, active/roadmap.md, active/EP-track-b-mockups.md
---
...
| `EP-track-b-mockups` | Phase 1 / Track B — UI mockups for Single-scenario MVP | ExecPlan | active | 2026-04-27 | — | `active/EP-track-b-mockups.md` |

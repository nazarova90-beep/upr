...
**Дизайн-система Lucent загружена в проект** (HTML + CSS, статус — draft). Лежит в `design-system/`. Это «исходник правды по визуалу». Перенос значений в код Flutter-приложения — будет отдельной задачей, когда начнём писать приложение (см. `design-system/README.md`).
